...
5. Download the [Jupyter Notebook](https://github.com/akicklig/Automated-Executive-Reporting/blob/main/Workflow_Files/pynb.ipynb) file. Running the first 6 code chunks will update the Excel worksheets with the queried SQL data.
